...
![4.2 垃圾回收原理 - 图3](memory-gc/gc-03-root_scan.png)

初始状态下所有对象都是白色的。

接着开始扫描根对象a、b:

![4.2 垃圾回收原理 - 图4](memory-gc/gc-04-root_scan_end.png)

由于根对象引用了对象A、B,那么A、B变为灰色对象，接下来就开始分析灰色对象，分析A时，A没有引用其他对象很快就转入黑色，B引用了D，则B转入黑色的同时还需要将D转为灰色，进行接下来的分析。如下图所示：

![4.2 垃圾回收原理 - 图5](memory-gc/gc-05-mark_phase2.png)

上图中灰色对象只有D，由于D没有引用其他对象，所以D转入黑色。标记过程结束：

![4.2 垃圾回收原理 - 图6](memory-gc/gc-06-mark_phase3.png)
...
![image-20201110233730505](memory-gc.assets/image-20201110233730505.png)

![image-20201110233833563](memory-gc.assets/image-20201110233833563.png)

<font color=red size=5x>遍历Root Set(非递归形式,值遍历一次)得到灰色节点,放入灰色标记表</font>

![image-20201110234055986](memory-gc.assets/image-20201110234055986.png)

![image-20201110234224240](memory-gc.assets/image-20201110234224240.png)

<font color=red size=5x>灰色只是一种标记状态,最终只有黑色和白色</font>

![image-20201110234351634](memory-gc.assets/image-20201110234351634.png)

<font color=red size=5x>最终删除白色</font>

![image-20201110234457223](memory-gc.assets/image-20201110234457223.png)



==<font color=blue size=5x>三色标记为什么需要STW</font>==

<font color=red size=5x>三色标记无STW的问题</font>

错误GC的情况,对象丢失

- 一个白色对象被黑色对象引用(白色背挂在黑色对象下)
- 灰色对象与它之间的可达关系的白色对象遭到破坏(灰色同时丢了该白色)

![image-20201110235136665](memory-gc.assets/image-20201110235136665.png)



![image-20201110235235796](memory-gc.assets/image-20201110235235796.png)



![image-20201110235306898](memory-gc.assets/image-20201110235306898.png)



![image-20201110235354834](memory-gc.assets/image-20201110235354834.png)
...
![image-20201111000227467](memory-gc.assets/image-20201111000227467.png)



若三色不变性

![image-20201111000457942](memory-gc.assets/image-20201111000457942.png)



![image-20201111000526666](memory-gc.assets/image-20201111000526666.png)
...
![image-20201111000913006](memory-gc.assets/image-20201111000913006.png)

![image-20201111001014865](memory-gc.assets/image-20201111001014865.png)
...
![image-20201111001717295](memory-gc.assets/image-20201111001717295.png)



![image-20201111002047422](memory-gc.assets/image-20201111002047422.png)



对象9可能被干掉

![image-20201111002124454](memory-gc.assets/image-20201111002124454.png)



![image-20201111002200648](memory-gc.assets/image-20201111002200648.png)



<font color=red size=5x>在回收白色之前,STW栈空间,时间大约10-100ms</font>

![image-20201111002242368](memory-gc.assets/image-20201111002242368.png)





![image-20201111002418029](memory-gc.assets/image-20201111002418029.png)



## 删除写屏障

![image-20201111002650170](memory-gc.assets/image-20201111002650170.png)

![image-20201111002856981](memory-gc.assets/image-20201111002856981.png)



场景

![image-20201111003022056](memory-gc.assets/image-20201111003022056.png)



![image-20201111003056353](memory-gc.assets/image-20201111003056353.png)



![image-20201111003121894](memory-gc.assets/image-20201111003121894.png)



![image-20201111003203599](memory-gc.assets/image-20201111003203599.png)



# ==---V1.8三色标记+混合写屏障---==

![image-20201111004012132](memory-gc.assets/image-20201111004012132.png)



![image-20201111004235028](memory-gc.assets/image-20201111004235028.png)



## 场景一

![image-20201111004608233](memory-gc.assets/image-20201111004608233.png)



![image-20201111004808712](memory-gc.assets/image-20201111004808712.png)



![image-20201111004849850](memory-gc.assets/image-20201111004849850.png)



## 场景二

![image-20201111005107299](memory-gc.assets/image-20201111005107299.png)

![image-20201111005323527](memory-gc.assets/image-20201111005323527.png)



![image-20201111005403757](memory-gc.assets/image-20201111005403757.png)



## 场景三

![image-20201111005552916](memory-gc.assets/image-20201111005552916.png)



![image-20201111005727878](memory-gc.assets/image-20201111005727878.png)



![image-20201111005910646](memory-gc.assets/image-20201111005910646.png)



![image-20201111010003407](memory-gc.assets/image-20201111010003407.png)



## 场景四

![image-20201111010149782](memory-gc.assets/image-20201111010149782.png)

![image-20201111010344122](memory-gc.assets/image-20201111010344122.png)



![image-20201111010411099](memory-gc.assets/image-20201111010411099.png)



![image-20201111010444140](memory-gc.assets/image-20201111010444140.png)
